...
Команды — Terminal, zsh/bash. Все пути ниже принадлежат вашему клону. Не запускайте их внутри копии с незавершённым merge. Проверенный код — `6990bba`; до согласованной интеграции используем `kashyyn/ml`, не выдаём её за финальную `main`.
